<x-ID-layout>
    <div class="container mx-auto px-4 py-8">
        ...
        <div class="grid grid-cols-6 lg:grid-cols-2 gap-4 mb-8">
            <!-- Kalender -->
            <div class="px-100 py-50 bg-blue-200 dark:bg-gray-900 overflow-hidden shadow-sm sm:rounded-lg p-20">
                <h3 class="font-semibold text-lg mb-15 text-blue-900 dark:text-white">{{ __('Kalender') }}</h3>
