<x-KIP-layout>
    ...
    <div class="overflow-x-auto">
        <table class="min-w-full bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-200 border border-gray-200 dark:border-gray-700">
            ...
            <tbody>
                ...
                <tr class="hover:bg-gray-200 dark:hover:bg-gray-600">
                    ...
                    <td class="px-4 py-2 border-b border-gray-200">
                        <a href="{{ route('KIP.ticket_show', $ticket->id) }}" class="text-red-600 dark:text-red-400 hover:underline">View Details</a>
                    </td>
                </tr>
                @endforeach
            </tbody>
