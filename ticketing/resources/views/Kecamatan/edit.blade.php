<x-app-layout>
    <h2 class="font-semibold text-xl text-center text-blue-600 dark:text-blue-400 leading-tight">
        {{ __('Edit Data Kecamatan/Kelurahan Anda') }}
    </h2>
    @if ($errors->any())
    <div class="mb-4">
...
<div class="max-w-lg mx-auto bg-custom text-white p-6 rounded-lg shadow-lg mt-10">
    <form action="{{ route('kecamatan.update' , $kecamatan) }}" method="POST">
        ...
        @method('PUT')
            <div class="mb-2">
                <label for="nama_kecamatan" class="block text-gray-700 light:text-gray-300">Nama</label>
                <input type="text" name="nama_kecamatan" class="text-black w-full px-4 py-2 border border-cyan-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-cyan-500"required>
            </div>
